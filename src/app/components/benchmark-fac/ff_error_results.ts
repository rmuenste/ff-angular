import { ErrorTableElement } from "./error_table_elem";

export const FF_ERROR_RESULTS: ErrorTableElement[] = [
...
export const VS_ERROR_RESULTS: ErrorTableElement[] = [
{name: "FFL2", errcdmax: 0.31, errclmin: 0.91, errl2cd: 0.29, errl2cl: 1.05, errlinfcd: 1.01, errlinfcl: 0.013},
{name: "OFL4", errcdmax: 0.2, errclmin: 1.8, errl2cd: 0.16, errl2cl: 1.47, errlinfcd: 0.61, errlinfcl: 0.02},
{name: "CFXL4", errcdmax: 0.3, errclmin: 2.73, errl2cd: 0.29, errl2cl: 2.24, errlinfcd: 1.20, errlinfcl: 0.03}
];
